#ifndef ROMEA_CORE_MOBILE_BASE_INFO_MOBILEBASEINFO2AS2FWD_HPP_
#define ROMEA_CORE_MOBILE_BASE_INFO_MOBILEBASEINFO2AS2FWD_HPP_
...
#endif  // ROMEA_CORE_MOBILE_BASE_INFO_MOBILEBASEINFO2AS2FWD_HPP_
