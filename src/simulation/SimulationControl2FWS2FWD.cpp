...
{
  HardwareCommand2FWS2FWD fakeHardwareCommand = {
  ...
  SimulationCommand2FWS2FWD fakeSimulationCommand = toSimulationCommand2FWS2FWD(
    wheelbase,
    frontTrack,
    rearTrack,
    frontWheelRadius,
  ...
  SimulationState2FWS2FWD simulationState;
