...
{
  core::HardwareCommand2AS2RWD fakeHardwareCommand = {
  ...
  SimulationCommand2AS2RWD fakeSimulationCommand = toSimulationCommand2AS2RWD(
    wheelbase,
    frontTrack,
    frontWheelRadius,
  ...
  SimulationState2AS2RWD simulationState;
