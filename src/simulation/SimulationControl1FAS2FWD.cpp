...
//-----------------------------------------------------------------------------
SimulationCommand1FAS2FWD toSimulationCommand1FAS2FWD(const HardwareCommand1FAS2FWD & hardwareCommand,
                                                      ...
                                                      const HardwareCommand1FAS2FWD & hardwareCommand)
{
  ...
  double linearSpeed = 0.5 * (frontLeftWheelLinearSpeed / TwoWheelSteeringKinematic::
                              computeWheelLinearSpeedRatio(-tanAxleSteeringAngle,
                                                           -instantaneousCurvature,
...
//-----------------------------------------------------------------------------
HardwareState1FAS2FWD toHardwareState1FAS2FWD(const SimulationState1FAS2FWD & simulationState,
