...
//                       const KinematicConstraints & userConstraints)
//{
//  //clamp curvature
...
//  double minimalSpeed = std::max(userConstraints.getMinimalSpeed(),
//                                 -maximalAbsoluteLinearSpeed);

//  double maximalSpeed = std::min(userConstraints.getMaximalSpeed(),
//                                 maximalAbsoluteLinearSpeed);
